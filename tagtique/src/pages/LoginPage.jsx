...
export default function LoginPage() {
  ...
  const handleLogin = (e) => {
    ...
    setTimeout(() => {
      setLoading(false);
      setMessage('Welcome back! Signed in successfully.');
      setUserProfile((prev) => ({
        ...prev,
  ...
  return (
    <div className="min-h-[calc(100vh-80px)] grid grid-cols-1 lg:grid-cols-12 font-manrope">
      ...
      {/* LEFT COLUMN: Dark Espresso Showcase matching Image 2 */}
      <div
      ...
      {/* RIGHT COLUMN: Cream Dot-Grid Login Form matching Image 2 */}
        ...
        <div className="w-full max-w-md bg-tag-card border-[1.5px] border-tag-border rounded-3xl p-6 sm:p-9 shadow-warm-lg flex flex-col gap-6">
          ...
          <form onSubmit={handleLogin} className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between text-xs pt-1">
              ...
              <a href="#forgot" className="font-bold text-tag-brown-light hover:text-tag-amber-deep">
                Forgot password?
              </a>
            </div>
